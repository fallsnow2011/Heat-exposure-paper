...
# Typical summer date: 15 July 2022, a non-heatwave summer day / 鍏稿瀷澶忔棩锛氶€夋嫨 2022 骞?7 鏈?15 鏃ワ紙闈炵儹娴棩鐨勬櫘閫氬鏃ワ級
TYPICAL_DATES = ['2022-07-15']
...
def process_city(city_name, date_str):
    """Run one day of typical-summer shadow simulation for a single city / 澶勭悊鍗曚釜鍩庡競鍗曞ぉ鐨勯槾褰辫绠?""
...
def main():
    print("="*60)
    print("Batch typical-day shadow simulation for five cities / 5 鍩庡競鍏稿瀷澶忔棩闃村奖璁＄畻鎵瑰鐞?)
    print("="*60)
    print(f"Cities / 鍩庡競: {CITIES}")
    print(f"Dates / 鏃ユ湡: {TYPICAL_DATES}")
    ...
    print("\n" + "="*60)
    print("Typical-day shadow simulation complete / 鍏稿瀷澶忔棩闃村奖璁＄畻瀹屾垚锛?)
    print("="*60)
